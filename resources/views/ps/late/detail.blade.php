...
<div class="container">
    <div class="text">
        ...
        <p><a href="{{ route('dashboardps') }}">Home</a> / <a href="{{ route('ps.late.rekapitulasi') }}">Data Keterlambatan</a> / 
            @php
            $first = true;
            @endphp
        ...
        @foreach ($lates as $late)
            @if ($first)
                <a href="{{ route('ps.late.show.ps', ['name_id' => $late->name_id]) }}">Detail Data Keterlambatan</a>
                @php
                    $first = false;
                @endphp
            @endif
        ...
        @foreach($lates as $late)
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="img">
                        <img src="{{ asset('img/' . $late->bukti) }}" alt="Bukti" class="card-img">
                    </div>
                </div>
            </div>
        @endforeach
