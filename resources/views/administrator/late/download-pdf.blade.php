...
<body>
    ...
    <div id="receipt" onclick="setTanggal()">
        <center>
            <div class="info">
            ...
            <div id="mid">
                <div class="info">
                    ...
                    @else
                        ...
                        <br>
                        <p>
                            Dengan ini menyatakan bahwa saya telah melakukan pelanggaran tata tertib sekolah, yaitu terlambat datang ke sekolah sebanyak (jumlah keterlambatan) yang mana hal tersebut termasuk kedalam pelanggaran kedisiplinan. Saya berjanji tidak akan terlambat datang ke sekolah lagi. Apabila saya terlambat datang ke sekolah lagi saya siap diberikan sanksi yang sesuai dengan peraturan sekolah.
                        </p>
                        <br>
